...
public class Python extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (quizTitle != null) quizTitle.setText("Python Quiz");
    ...
    private String getJsonFileName() {
        switch (difficulty) {
            case "medium": return "python_medium.json";
            case "hard":   return "python_hard.json";
            default:       return "python_easy.json";
        }
    }
