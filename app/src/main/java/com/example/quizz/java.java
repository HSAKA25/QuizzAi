...
public class java extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (quizTitle != null) quizTitle.setText("Java Quiz");
    ...
    private String getJsonFileName() {
        switch (difficulty) {
            case "medium": return "java_medium.json";
            case "hard":   return "java_hard.json";
            default:       return "java_easy.json";
        }
    }
