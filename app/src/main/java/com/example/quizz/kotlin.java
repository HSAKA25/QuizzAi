...
public class kotlin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getIntent() != null) {
            ...
            if (d != null) difficulty = d.toLowerCase();
        }
        bindViews();

        // Fix hardcoded title from shared layout
        android.widget.TextView quizTitle = findViewById(R.id.quizTitle);
        if (quizTitle != null) quizTitle.setText("Kotlin Quiz");
    ...
    private String getJsonFileName() {
        switch (difficulty) {
            case "medium": return "kotlin_medium.json";
            case "hard":   return "kotlin_hard.json";
            default:       return "kotlin_easy.json";
        }
    }
    ...
    private void displayQuestion() {
        ...
        List<String> opts = q.getOptions();   // ✅ correct method
        ...
        // ✅ use list index — not getOption1/2/3/4
    ...
    private void handleSubmit() {
        ...
        String correct   = questionList.get(currentIndex).getAnswer().trim(); // ✅ getAnswer()
